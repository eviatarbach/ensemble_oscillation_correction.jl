...
function ens_forecast_compare(; model, model_err, integrator, m, M, D, k, k_r, modes,
    ...
    tree, tree_r, EW_nature, EV_nature, y_nature, r, C1, mu = Embedding.create_tree(model=model, record_length=record_length,
    ...
    E = integrator((t, u)->model_err(t, u + mu), y_nature[end, :], 0.0, m*Δt*outfreq, Δt, inplace=false)[1:outfreq:end, :]'
